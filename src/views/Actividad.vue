  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Organización de los residuos
        p.mb-4 Determinar los tipos de residuos sólidos con base en sus características particulares para una adecuada clasificación.
